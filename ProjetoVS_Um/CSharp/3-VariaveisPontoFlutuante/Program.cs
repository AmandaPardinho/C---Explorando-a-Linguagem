...
class Program
{
    static void Main(string[] args)
    {
        ...
        /*Uma variável do tipo double aceita um número inteiro, mas uma variável inteiro não aceita um número com ponto flutuante.
          Quando fazemos uma divisão de dois inteiros, mas os declaram como double pois o resultado será um número com ponto flutuante, obteremos como resposta um número também inteiro (não é um arredondamento).
